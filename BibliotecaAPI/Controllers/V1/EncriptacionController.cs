...
namespace BibliotecaAPI.Controllers.V1
{
    ...
    public class EncriptacionController: ControllerBase
    {
        ...
        [HttpGet("encriptar", Name = "EncriptarTextoV1")]
        [OutputCache]
        ...
        [HttpGet("encriptarConTiempo", Name ="EncriptarTextoConTiempoV1")]
        [OutputCache]
        ...
        [HttpGet("desencriptar", Name = "DesencriptarTextoV1")]
        [OutputCache]
        ...
        [HttpGet("desencriptarConTiempo", Name = "DesencriptarTextoConTiempoV1")]
        [OutputCache]
