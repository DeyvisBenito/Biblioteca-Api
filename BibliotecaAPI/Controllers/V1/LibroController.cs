...
namespace BibliotecaAPI.Controllers.V1
{
    ...
    public class LibroController: ControllerBase
    {
        ...
        private const string cache = "libros-obtenerV1";
        ...
        [HttpGet("obtenenerToken", Name ="ObtenerTokenLibroV1")]
        ...
        public ActionResult ObtenerTokenPorTiempo()
        {
            ...
            var url = Url.RouteUrl("obtenerLibrosAccesoTokenV1", new { tokenAutorizado }, "http");

            return Ok(url);
        }

        [HttpGet("obtenerLibrosToken/{tokenAutorizado}", Name = "obtenerLibrosAccesoTokenV1")]
        [AllowAnonymous]
        [OutputCache(Tags = [cache])]
        ...
        public async Task<ActionResult> Post(LibroCreacionDTO libroCreacionDTO)
        {
            ...
            return CreatedAtRoute("ObtenerLibroV1", new {libro.Id}, libroDTO);
        }
